...
import { onboardUserAdapter } from "@control-plane/user/adapters/primary/onboarding.adapter";
...
export const onboardUserHandler = createSQSHandler(onboardUserAdapter);
